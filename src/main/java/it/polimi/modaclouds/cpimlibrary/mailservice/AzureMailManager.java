...
/**
 * This class allows to send a mail through the mail service on the Windows Azure
 * platform.
 */
class AzureMailManager extends CloudMailManager {
	...
	/**
	 * Instantiates a {@code AzureMailManager} through the metadata specified in
	 * the <u>configuration.xml</u> file in the <i>mail</i> tag.
	 * 
	 * @param metadata
	 *            - object that contains all the information setting.
	 */
	public AzureMailManager(CloudMetadata metadata) {
