...
public class QueryStringTest {
    ...
    public void testUpdate() {
        ...
        Assert.assertEquals("UPDATE Test SET name = 'Fabio', salary = '123' WHERE salary >= '45'", update.toString());
    }
    ...
    public void testDelete() {
        ...
        Assert.assertEquals("DELETE FROM Test WHERE salary <= '45'", delete.toString());
    }
}
